...
###REQUIRES UNLISTING OF COLUMNS WHICH ARE LISTS. I RECOMMEND RUNNING DataCleaning2 to save as soccer.csv
write.csv(WomenSoccer,"/Volumes/Sanchez/My CMSA Camp/Soccer-master/open-data-master/WomenSoccer.csv")
